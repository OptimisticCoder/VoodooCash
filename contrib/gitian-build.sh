...
VERSION=
commit=false
url=https://github.com/voodoo-cash/VoodooCash
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the voodoocash, gitian-builder, gitian.sigs.ltc, and litecoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/voodoo-cash/VoodooCash
