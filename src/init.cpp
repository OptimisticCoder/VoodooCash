...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/voodoo-cash/VoodooCash>";
    const std::string URL_WEBSITE = "<https://voodoocash.io>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("VoodooCash version %s\n", FormatFullVersion());
}
