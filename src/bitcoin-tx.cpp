...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s voodoocash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  voodoocash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded voodoocash transaction") + "\n" +
              "  voodoocash-tx [options] -create [commands]   " + _("Create hex-encoded voodoocash transaction") + "\n" +
              "\n";
