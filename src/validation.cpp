...
#if defined(NDEBUG)
# error "VoodooCash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "VoodooCash Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s VDC additional fees, %d delta bytes\n",
